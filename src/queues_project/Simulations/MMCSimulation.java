...
public class MMCSimulation {
    public MMCSimulation(double ARRIVAL_RATE, double SERVICE_RATE, int NUM_SERVERS, int SIMULATION_TIME) {
    ...
    private  void createAndShowGUI() {
        JFrame frame = new JFrame("M/M/C Queue Simulation");
